...
export default function HomeScreen({ navigation }) {
    ...
    const RightActions = (progress, id) => {
        return (
            <View  >
                <TouchableOpacity
                    style={styles.button}
                    onPress={() => { markAsDone(id) }}
                >
                    <Text style={styles.doneButtonText}>Mark As </Text>
    ...
    const Item = ({ title, date, onRightPress, id }) => (
        <TouchableOpacity
            onPress={() => navigation.navigate('Add', { userId: id, buttonName:'Edit' })}>
            <Swipeable style={styles.itemBackground}
                renderRightActions={(progress) => RightActions(progress,id)}
            >
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.topBar}>
                <Text style={styles.topBarText}>Todos</Text>
                <Avatar
                    rounded
                    size="medium"
                    source={{
